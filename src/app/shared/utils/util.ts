 ...
 */
export const formatFileSize = (sizeInBytes: number, suffix: 'short' | 'long' | 'none', baseSize = 1024, threshold = 1024): string => {
  const fileSizeUnits = ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'];
  const fileSizeUnitsLong = ['Bytes', 'Kilobytes', 'Megabytes', 'Gigabytes', 'Pettabytes', 'Exabytes', 'Zettabytes', 'Yottabytes'];
  let units: string[] = []
